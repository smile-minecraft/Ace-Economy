...
### AceLib v1.2.1 download and checksum

Download `AceLib-1.2.1.jar` from the AceLib v1.2.1 GitHub Release: <https://github.com/smile-minecraft/AceLib/releases/tag/v1.2.1>.
...
- `AceLib-1.2.1.jar` is present and no older AceLib JAR is active.
