...
- Confirm that `plugins/AceLib-1.2.1.jar` and `plugins/AceEconomy-2.1.0.jar` exist.
...
**Fix:** use Java 25 with Paper/Folia 26.1.2, install one `AceLib-1.2.1.jar`, and perform a full server restart. Do not try to fix a missing hard dependency with `/aceeco reload`.
