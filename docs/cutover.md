...
| AceLib | `com.github.smile-minecraft:AceLib:v1.2.1` (`compileOnly`; runtime supplied by an external JAR; **must not be shaded**) | `build.gradle.kts` |
...
2. Put `AceLib-1.2.1.jar` and `AceEconomy-2.1.0.jar` in `plugins/`; AceLib is hard dependency.
